...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div id="section-search" class="section">
            ...
            <div class="search-box">
                <input
                    type="text"
                    id="search-input"
                    placeholder="Search users, content, research..."
                />
        ...
        <div id="section-users" class="section">
            ...
            <div class="users-filter">
                ...
                <button onclick="filterById()" class="btn btn-secondary">
                    Filter
                </button>
            </div>
            ...
            <div class="users-advanced">
                ...
                <input
                    type="text"
                    id="user-filter"
                    placeholder="Custom filter expression"
                />
                <button onclick="advancedFilter()" class="btn btn-secondary">
                    Apply
                </button>
            </div>
    ...
    <script>
        ...
        function showSection(section) {
            ...
            document
                .getElementById(sectionMap[section] || "section-comments")
